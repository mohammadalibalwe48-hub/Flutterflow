...
class SliderWidget extends StatefulWidget {
  const SliderWidget({
    ...
    bool? disabled,
    bool? showTicks,
  })  : this.label = label ?? 'Weekly Study Target',
        this.labelPresent = labelPresent ?? true,
        this.description = description ?? 'Focus on History & Science',
        this.descriptionPresent = descriptionPresent ?? true,
        this.valuePercentage = valuePercentage ?? 75.0,
        this.valueLabel = valueLabel ?? '15/20 hrs',
